import {Extension, State, TokenizeContext, Event, Effects, Code} from 'micromark-util-types';
...
import {H, MdastNode} from 'mdast-util-to-hast/lib';
 ...
 */
function fromMarkdown(options?: Options):Extension {
  const tokenizer = {
  ...
  /** @-type {Tokenizer} */
  function tokenizeUnderline(effects: Effects, ok: State, nok: State): State {
 ...
 */
function toHtml(h: H, node: MdastNode) {
